...
class CatalogServiceApplicationTests {
    ...
    //We now want to test Catalog Service in isolation and verify different authorization scenarios. Therefore, we need to generate some Access Tokens first, so that we can use them to call the Catalog Service endpoints under testing.
    //realm-config.json should be in src/test/resources folder of your Catalog Service project
    //Password Grant Type we’ll use it just for testing purposes.
    @Container
    ...
    private static KeycloakToken authenticateWith(String username, String password, WebClient webClient) {
        return webClient
                ...
                .block();//Blocks until a result is available. This is how we use WebClient imperatively rather than reactively.
    }
